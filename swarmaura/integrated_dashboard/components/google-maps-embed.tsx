...
import { Loader2, MapPin, Truck, Route, Clock, Users, Package, Navigation, Zap, AlertTriangle, ExternalLink } from "lucide-react"
      ...
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading Google Maps integration...</p>
          </div>
        </div>
      </div>
    )
          ...
          <>
            ...
            <div className="absolute inset-0 pointer-events-none z-5">
              {locations.map((location, index) => {
                ...
                // Convert lat/lng to approximate screen position (this is a simplified approach)
                const x = ((location.lng - mapCenter[1] + 0.1) / 0.2) * 100
                const y = ((mapCenter[0] - location.lat + 0.1) / 0.2) * 100
