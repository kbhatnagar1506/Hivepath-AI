...
export async function fetchLocations(): Promise<Location[]> {
  try {
    ...
    console.log("[SwarmAura] Fetched live location data:", result.count, "locations")
    return result.data || []
  } catch (error) {
    console.log("[SwarmAura] Using mock location data (API unavailable):", error)
...
export async function fetchVehicles(): Promise<Vehicle[]> {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live vehicle data:", result.count, "vehicles")
    return result.data || []
  } catch (error) {
    console.log("[SwarmAura] Using mock vehicle data (API unavailable):", error)
...
export async function fetchPredictions(): Promise<Prediction[]> {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live prediction data:", result.count, "predictions")
    return result.data || []
  } catch (error) {
    console.log("[SwarmAura] Using mock prediction data (API unavailable):", error)
...
export async function fetchAnalytics(): Promise<Analytics> {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live analytics data:", result.data)
    return result.data || MOCK_ANALYTICS
  } catch (error) {
    console.log("[SwarmAura] Using mock analytics data (API unavailable):", error)
...
export async function fetchBulkData() {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live bulk data:", result.status)
    return result.data || { locations: MOCK_LOCATIONS, vehicles: MOCK_VEHICLES, analytics: MOCK_ANALYTICS }
  } catch (error) {
    console.log("[SwarmAura] Using mock bulk data (API unavailable):", error)
    return {
...
// Additional API functions for SwarmAura integration
export async function fetchAccessibilityData() {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live accessibility data:", result.count, "assessments")
    return result.data || []
  } catch (error) {
    console.log("[SwarmAura] Using mock accessibility data (API unavailable):", error)
    return []
  }
}
...
export async function fetchWeatherData() {
  try {
    const response = await fetch(`${API_BASE_URL}/api/environmental/weather`, {
      signal: AbortSignal.timeout(5000),
    })
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live weather data:", result.status)
    return result.data || {}
  } catch (error) {
    console.log("[SwarmAura] Using mock weather data (API unavailable):", error)
    return {}
  }
}
...
export async function fetchTrafficData() {
  try {
    const response = await fetch(`${API_BASE_URL}/api/environmental/traffic`, {
      signal: AbortSignal.timeout(5000),
    })
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] Fetched live traffic data:", result.status)
    return result.data || {}
  } catch (error) {
    console.log("[SwarmAura] Using mock traffic data (API unavailable):", error)
    return {}
  }
}
...
export async function fetchSystemHealth() {
  try {
    ...
    if (!response.ok) throw new Error("API request failed")
    const result = await response.json()
    console.log("[SwarmAura] System health:", result.status)
    return result
  } catch (error) {
    console.log("[SwarmAura] Health check failed:", error)
