...
import { AlertTriangle, Zap, Clock, Activity, BarChart3, Menu } from "lucide-react"
      ...
      <header className="border-b border-border bg-card">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-6">
            <div 
              className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-all duration-300 ease-out hover:scale-105 active:scale-95"
            ...
            >
              ...
              />
              <Zap className="h-10 w-10 text-primary-foreground hidden" />
            </div>
